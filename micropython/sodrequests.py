...
class Response(object):
    def __init__(self, status_code, raw, headers):
...
# Adapted from upip
def request(method, url, data=None, json=None, timeout=None, headers=None):
    ...
    if json is not None:
        ...
        content = '&'.join('='.join([key, value]) for key, value in data.items())
